...
public class FunctionalInterfaces {
    ...
    /**
     * Unary operator takes 1 argument and returns a result in same data type of the argument.
     * Input - 1 argument
     * Returns - 1 result
     * Data type - Same for both
     */
    ...
    /**
     * Binary operator takes 2 arguments of the same type and returns a result in same data type of arguments.
     * Input - 2 arguments
     * Returns - 1 result
     * Data type - Same for all
     */
    private static void binaryOperator() {
        ...
        log.info("binaryOperatorStockValue -> Your portfolio value is {}", binaryOperatorStockValue.apply(stockUnits, stockPrice));

        log.info("***   binaryOperator demo    ***\n");
    }

    /**
     * Function takes 1 argument and returns a result. Data type of input and output can be different
     * Input - 1 argument
     * Returns - 1 result
    ...
    /**
     * BiFunction takes 2 arguments and returns a result. Data type of input and output can be different
     * Input - 2 arguments
     * Returns - 1 result
     * Data type - Can be different
     */
    private static void biFunction() {
        ...
        int stockUnits = 45;
        double stockPrice = 567.89;
        BiFunction<Integer, Double, String> biFunctionStockValue = (units, price) -> ("Your portfolio value is " + (units * price));
    ...
    /**
     * Predicate takes 1 argument and returns boolean result.
     * Input - 1 argument
     * Returns - boolean
     * Data type - Can be different
     */
    private static void predicate() {
        ...
        var age = 20;
        log.info("votingEligibilityValidation Predicate in action. Input {} is eligible for voting - {}"
                , age
    ...
    /**
     * BiPredicate takes 2 arguments and returns boolean result.
     * Input - 2 arguments
     * Returns - boolean
     * Data type - Can be different
     */
    private static void biPredicate() {
        ...
        var age = 50;
        var income = 200000D;
        log.info("eligibleForTaxConcession BiPredicate in action. Input {} is eligible for tax concession - {}"
                , age
    ...
    /**
     * Consumer takes 1 argument and returns no result.
     * Input - 1 argument
     * Returns - void
     */
    private static void consumer() {
        ...
        Consumer<Integer> votingEligibilityValidation = age -> {
            if (age >= 18)
                log.info("Age {}. Eligible for voting", age);
            else
                log.info("Age {}. Not eligible for voting", age);
        };
    ...
    /**
     * Supplier takes no argument but returns a result.
     * Input - no input
     * Returns - 1 result
     * Data type - anything
     */
    private static void supplier() {
        ...
        // sample 1
        Supplier<List<String>> daysSupplier = () -> List.of("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
